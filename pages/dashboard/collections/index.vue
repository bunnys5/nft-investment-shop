      ...
      <div class="section wf-section">
        <div class="div-block-30">
          <div class="text-block-18">
            <span class="text-span-7">Page / </span>Collections
          </div>
          <div class="text-block-19">Collections</div>
        </div>
        <div class="div-block-34">
          <div class="div-block-35">
            <div class="div-block-37">
              <div class="div-block-38">
                <div class="text-block-22">Collections ทั้งหมด</div>
              </div>
            </div>
...
<style scoped>
@import url(../../../styles/collectionsD/collectionD.css);
</style>
